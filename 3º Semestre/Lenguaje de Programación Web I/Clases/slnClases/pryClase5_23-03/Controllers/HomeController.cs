...
namespace pryClase4_18_03.Controllers
{
    ...
    {
        static List<Datos> lista = new List<Datos>();
        ...
        public IActionResult Nuevo(string nUsuario, string nContraseña, string nHabilitado)
        {
            lista.Add(new Datos()
            {
                usuario_ = nUsuario,
                contraseña_ = nContraseña,
                habilitado_ = nHabilitado
            });
